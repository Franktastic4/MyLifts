 ...
 */
public class ListRowAdapterExercise extends BaseAdapter
{
    public ArrayList<HashMap> list;
    Activity activity;

    public ListRowAdapterExercise(Activity activity, ArrayList<HashMap> list) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            convertView = inflater.inflate(R.layout.list_view_row_exercise,null);
